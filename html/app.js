...
const ShowBasicTopNotification = (text, duration) => {
	const struct1 = new DataView(new ArrayBuffer(48));
	struct1.setInt32(0, duration, true); // duration
...
const ShowSimpleCenterText = (text, duration) => {
	const struct1 = new DataView(new ArrayBuffer(48));
	struct1.setInt32(0, duration, true); // duration
...
const ShowLocationNotification = (text, location, duration) => {
	const struct1 = new DataView(new ArrayBuffer(48));
...
const ShowTopNotification = (title, subtext, duration) => {
	const struct1 = new DataView(new ArrayBuffer(48));
	struct1.setInt32(0, duration, true); // duration
...
const ShowAdvancedLeftNotification = (title, subTitle, dict, icon, duration) => {
	const struct1 = new DataView(new ArrayBuffer(48));
	struct1.setInt32(0, duration, true);
...
const ShowAdvancedRightNotification = (text, dict, icon, text_color, duration) => {
...
window.addEventListener('message', (event) => {
	...
	const secondtext = data.secondtext
	...
	switch (type) {
		case 'Tip':
			return ShowTooltip(text, duration);
		case 'RightText':
			return DisplayRightText(text, duration);
		case 'ShowObjective':
			return ShowObjective(text, duration);
		case 'ShowBasicTopNotification':
			return ShowBasicTopNotification(text, duration);
		case 'ShowSimpleCenterText':
			return ShowSimpleCenterText(text, duration);
		case 'ShowLocationNotification':
			return ShowLocationNotification(text, location, duration);
		case 'ShowTopNotification':
			return ShowTopNotification(title, subtitle, duration);
		case 'ShowAdvancedLeftNotification':
			return ShowAdvancedLeftNotification(text, secondtext, dict, icon, duration);
		case 'ShowAdvancedRightNotification':
			return ShowAdvancedRightNotification(text, dict, icon, color, duration);
		default:
			return;
	}
})