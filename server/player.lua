    ...
    if src then
        if citizenid then
            ...
            if PlayerData and license == PlayerData.license then
                ...
                TriggerEvent('qbr-log:server:CreateLog', 'anticheat', 'Anti-Cheat', 'white', GetPlayerName(src) .. ' Has Been Dropped For Character Joining Exploit', false)
            end
        else
...
function QBCore.Player.DeleteCharacter(source, citizenid)
    ...
    if license == result then
        ...
        MySQL.Async.transaction(queries, function(result)
			if result then
				TriggerEvent('qbr-log:server:CreateLog', 'joinleave', 'Character Deleted', 'red', '**' .. GetPlayerName(src) .. '** ' .. license .. ' deleted **' .. citizenid .. '**..')
            end
		end)
    else
        DropPlayer(src, 'You Have Been Kicked For Exploitation')
        TriggerEvent('qbr-log:server:CreateLog', 'anticheat', 'Anti-Cheat', 'white', GetPlayerName(src) .. ' Has Been Dropped For Character Deletion Exploit', false)
    end
end
